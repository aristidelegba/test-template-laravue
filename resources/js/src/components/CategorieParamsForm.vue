    ...
    <div class="">
                        ...
                        <div class="d-flex flex-column ml-1">
                            ...
                            <div>
                                <input
                                    ...
                                    value="A"
                                />
                                <label>Article fabriqué en interne</label>
                            </div>
                            <div>
                                <input
                                    type="radio"
        ...
        <div class="border border-dark rounded p-1 mt-3" id="prixAchat">
            ...
            <div class="border border-dark rounded p-1 mt-3">
                ...
                <div
                    class="btn d-flex justify-content-end pr-2 mt-1 mb-1"
                    @click="optionAvanceePrixAchat = !optionAvanceePrixAchat"
                >
                    Options avancés
                </div>
                <div
                ...
                >
                    <div class="d-flex flex-column text-right vl mr-1 p-1">
                        ...
                        <div class="mt-3">
                            <strong>Règle de valorisation en stock</strong>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="mt-1">
                                <strong
                                    >{{ choiceDevice }} {{ choiceTaxe }}</strong
                                >
                            </div>
                        </div>
        ...
        <div class="border border-dark rounded p-1 mt-3" id="logistique">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="">
                                <b-form-group>
                                    <b-form-input type="text" id="basicInput"
                                /></b-form-group>
                            </div>
                        </td>
                        <td>-</td>
            ...
            <span class="d-flex justify-content-between ml-1 mr-1">
                <div>
                    Soit <strong>0</strong> colis, pour un poids total de
                    <strong>0,000 kg</strong> et un volume global de
            ...
            <div
                ...
                @click="optionAvanceeLogistique = !optionAvanceeLogistique"
            >
                Options avancés
            </div>
            <div
        ...
        <div class="border border-dark rounded p-1 mt-3" id="infoSup">
            ...
            <div class="d-flex flex-row">
                ...
                <div class="col-8">
                    ...
                    <div>
                        <strong
                            >Aucune caractéristique n'est définit pour cet
                            article</strong
                        >
                    </div>
                    <hr />
                    ...
                    <div>
                        <strong
                            >Aucune personnalisation n'est définit pour cet
                            article</strong
                        >
                    </div>
                    <hr />
                    ...
                    >
                        <div class="h4">
                            <strong class="m-auto"> est associé à </strong>
                        </div>
                        <div>
                ...
                <div class="col-4">
                    ...
                    <div class="dropbox">
                        ...
                        />
                        <p v-if="isInitial">
                            Glisser déposer vos fichiers pour commencer<br />
                            ou clicker pour naviguer
                        </p>
                        <p v-if="isSaving">{{ fileCount }} fichiers ...</p>
                    </div>
                    <hr />
            ...
            <div
                class="btn d-flex justify-content-end pr-2 mt-1 mb-1"
                @click="optionAvanceeInfosComp = !optionAvanceeInfosComp"
            >
                Options avancés
            </div>
